...
struct HeaderView: View {
    ...
    var body: some View {
        ...
        GeometryReader { geo in
            ...
            let adjustmentWidth = (width/2) - leftrightSpacing // 첫번째 index일때 왼쪽에 spacing을 추가적으로 더해줌 -> 결과값: 16
            ZStack (alignment: .bottom){
                ...
                .offset(x: CGFloat(currentIndex)*(-width) + (currentIndex == 0 ? 16 : 38) + offset) // offset
            } // ZStack
            .gesture(
                DragGesture()
